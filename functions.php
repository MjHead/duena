...
function duena_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'duena' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'duena_custom_background_args', array(
 ...
 */
function duena_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'duena_content_width', 640 );
}
add_action( 'after_setup_theme', 'duena_content_width', 0 );
